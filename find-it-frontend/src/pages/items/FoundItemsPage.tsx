      ...
      <div className="grid gap-5">
        {loading
          ...
          : items.length > 0
            ...
            : <div className="rounded-[1.5rem] border border-dashed border-black/10 bg-white/60 p-8 text-center text-sm text-ink/60 dark:border-white/10 dark:bg-white/5 dark:text-paper/60">No found items match your filters.</div>}
      </div>
    </div>
  )
}
