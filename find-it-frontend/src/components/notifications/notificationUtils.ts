...
export const notificationTypeLabels: Record<Notification['type'], string> = {
  ...
  claim_awaiting_receipt: 'Claim ready for pickup',
...
export const notificationTypeTones: Record<Notification['type'], string> = {
  ...
  claim_awaiting_receipt: 'bg-emerald-500/12 text-emerald-700 dark:bg-emerald-500/20 dark:text-emerald-100',
  claim_completed: 'bg-emerald-500/12 text-emerald-700 dark:bg-emerald-500/20 dark:text-emerald-100',
